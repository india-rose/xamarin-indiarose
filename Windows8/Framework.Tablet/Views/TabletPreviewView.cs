...
namespace IndiaRose.Framework.Views
{
    public class TabletPreviewView : Grid
    {
        ...
        public static readonly DependencyProperty IndiagramSizeProperty = DependencyProperty.Register(
            "IndiagramSize", typeof (int), typeof (TabletPreviewView), new PropertyMetadata(default(int)));
        ...
        public TabletPreviewView()
        {
            ...
            _stackPanel.Children.Add(_topButton);
            _stackPanel.Children.Add(_bottomButton);
            
            SizeChanged += TabletPreview_SizeChanged;
        }

        void _bottomButton_Tapped(object sender, Windows.UI.Xaml.Input.TappedRoutedEventArgs e)
        {
        ...
        void _topButton_Tapped(object sender, Windows.UI.Xaml.Input.TappedRoutedEventArgs e)
        {
