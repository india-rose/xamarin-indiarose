...
{
	[Activity(Label = "India Rose Admin", MainLauncher = true, Icon = "@drawable/ir_logo_params", ScreenOrientation = ScreenOrientation.Landscape, Theme = "@style/Theme.Sherlock.Light.NoActionBar", LaunchMode = LaunchMode.SingleInstance, NoHistory = true)]
