...
{
	[Activity(Label = "India Rose", MainLauncher = true, Icon = "@drawable/ir_logo", Theme = "@style/Theme.Sherlock.Light.NoActionBar", ScreenOrientation = ScreenOrientation.Landscape, LaunchMode = LaunchMode.SingleInstance, NoHistory = true)]
