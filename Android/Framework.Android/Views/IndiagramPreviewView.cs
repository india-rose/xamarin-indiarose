...
{
    /// <summary>
    /// Vue préfabriqué pour la prévisualisation d'un Indiagram
    /// </summary>
    public class IndiagramPreviewView : RelativeLayout
    {
        ...
        #region Constructors
        protected IndiagramPreviewView(IntPtr javaReference, JniHandleOwnership transfer)
            : base(javaReference, transfer)
        {
            Initialize();
        }

        public IndiagramPreviewView(Context context)
            : base(context)
        {
            Initialize();
        }

        public IndiagramPreviewView(Context context, IAttributeSet attrs)
            : base(context, attrs)
        {
            Initialize();
        }

        public IndiagramPreviewView(Context context, IAttributeSet attrs, int defStyleAttr)
