...
namespace Application.Tablet.Views.Dialogs
{
    ...
    /// </summary>
    public sealed partial class DeleteCategoryConfirmation
    {
        public IScreenService ScreenService => LazyResolver<IScreenService>.Service;

        public DeleteCategoryConfirmation() : base((int)Window.Current.Bounds.Height - (int)Window.Current.Bounds.Height * 55 / 100)
        {
