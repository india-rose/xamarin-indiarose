...
namespace Application.Tablet.Views.Dialogs
{
    ...
    /// </summary>
    public sealed partial class DeleteIndiagramWarningDialog
    {
        public IScreenService ScreenService => LazyResolver<IScreenService>.Service;

        public DeleteIndiagramWarningDialog() : base((int)Window.Current.Bounds.Height - (int)Window.Current.Bounds.Height * 55 / 100)
        {
